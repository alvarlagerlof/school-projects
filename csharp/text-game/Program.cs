...
namespace textgame
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Question = new string[] {"Konv", "1: hej\n2: hej\n1:hejdå", "Vad vill du göra?"},
        ...
        static Choice FoundHouse() 
        {
            return new Choice
                {
                    Question = new string[] {"Du hittade ett hus.\nVad gör du nu?"},
                    Options = new Dictionary<string, Func<Choice?>>()
                    {
        ...
        static Choice InsideHouse() 
        {
            return new Choice
                {
                    Question = new string[] {"Det är ett monster i huset.\nVad gör du?"},
                    Options = new Dictionary<string, Func<Choice?>>()
                    {
                        ["Flyr"] = () => { Die(); return null; },
                        ["Kramar monstret"] = () => { return new Choice
                            {
                                Question = new string[] {"Monstret blir din bästa vän och vill inte att du lämnar någonsin.\nVad gör du?"},
                                Options = new Dictionary<string, Func<Choice?>>()
                                {
                                    ["Flyr"] = () => { Die(); return null; },
                                    ["Stannar där för evigt"] = () => { return new Choice
                                        {
                                            Question = new string[] {"Monstret är nu trött på dig.\nVad gör du?"},
                                            Options = new Dictionary<string, Func<Choice?>>()
                                            {
        ...
        static Choice Path() 
        {
            return new Choice
                {
                    Question = new string[] {"Du kom ut ur huset. I skogen ser du en liten stig. Du går dit.\nPlötsligt hör du ett ljud! PANG!\nVad gör du?"},
                    Options = new Dictionary<string, Func<Choice?>>()
                    {
                        ["Flyr från skottet"] = () => { Die(); return null; },
                        ["Går långsamt mot ljudkällan"] = () => { return new Choice
                                {
                                    Question = new string[] {"Det visar sig vara en kokosnöt.\nVad gör du?"},
                                    Options = new Dictionary<string, Func<Choice?>>()
                                    {
        ...
        static Choice Garden() 
        {
            return new Choice
                {
                    Question = new string[] {"Du ser nu en stor trädgråd. På en skylt finns det tre texter med varsin knapp.\nÖver detta står det 'Enligt alternativ mattematik, vilken beräkning är rätt?'"},
                    Options = new Dictionary<string, Func<Choice?>>()
                    {
